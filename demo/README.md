...
### ⭐ [Skia / CameraProcessor](SkiaCameraProcessor)

This repository showcases a demo project implementing **Skia** for React Native, focusing on creating graphical effects and animations, along with a camera processor using **react-native-vision-camera**
**Features**

- Skia usage, animation and shader
- Camera Face detection
- Camera filtering effect with Skia
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/danhmaisgt/"><img src="https://avatars.githubusercontent.com/u/164838448?v=4" width="70px;" alt="Danh Mai" style="border-radius: 50%;"/><br /><sub><b>Danh Mai</b></sub></a><br /></td>
  </tr>
</table>
